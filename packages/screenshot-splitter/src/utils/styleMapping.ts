...
export const styleMapping = {
  ...
  'btn-primary': 'bg-blue-600 text-white hover:bg-blue-700 focus:ring-4 focus:ring-blue-300 focus:ring-offset-2 border-2 border-blue-700',
  'btn-secondary': 'bg-gray-200 text-gray-800 hover:bg-gray-300 focus:ring-4 focus:ring-gray-300 focus:ring-offset-2 border-2 border-gray-300',
  'btn-danger': 'bg-red-600 text-white hover:bg-red-700 focus:ring-4 focus:ring-red-300 focus:ring-offset-2 border-2 border-red-700',
  
  // 预览相关样式
  'preview-container': 'flex flex-col lg:flex-row gap-4 lg:gap-6 p-4 lg:p-6 bg-white rounded-lg shadow-sm w-full max-w-full',
  'preview-header': 'flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-4 lg:mb-6 w-full',
  ...
  'thumbnail-item': 'relative flex items-center gap-4 p-4 bg-white border-2 border-gray-200 rounded-xl hover:shadow-lg hover:border-blue-300 transition-all duration-200 cursor-pointer',
  'thumbnail-item-selected': 'border-green-500 bg-green-50 ring-2 ring-green-500 ring-opacity-50 shadow-md',
  'thumbnail-item-active': 'border-blue-500 bg-blue-50 ring-2 ring-blue-500 ring-opacity-30',
  'thumbnail-checkbox': 'w-6 h-6 text-green-500 border-2 border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 cursor-pointer',
  'thumbnail-img': 'w-20 h-20 lg:w-24 lg:h-24 object-cover rounded-lg border-2 border-gray-200 shadow-sm',
  ...
  'thumbnail-number': 'absolute -top-2 -left-2 bg-blue-600 text-white text-xs font-bold px-2 py-1 rounded-full min-w-[24px] text-center',
  'thumbnail-select-btn': 'absolute -top-2 -right-2 w-8 h-8 bg-gray-200 hover:bg-blue-600 text-gray-600 hover:text-white font-bold rounded-full flex items-center justify-center transition-all duration-200 shadow-md',
  'thumbnail-select-btn-selected': 'bg-green-600 text-white hover:bg-green-700',
  
  // 大图预览相关样式 - PC端右侧预览区
  'preview-main': 'flex-1 flex flex-col items-center justify-center min-h-[500px] lg:min-h-[600px] bg-gray-50 rounded-lg p-4',
  'preview-image-container': 'relative w-full max-w-full overflow-hidden rounded-lg bg-white shadow-md',
  ...
  'loading-spinner': 'px-6 py-4 bg-blue-100 rounded-lg text-blue-700 text-base font-medium shadow-sm',
  'image-error-container': 'flex flex-col items-center justify-center p-8 text-center bg-red-50 border-2 border-dashed border-red-200 rounded-lg min-h-[200px]',
  'error-icon': 'text-5xl mb-4',
  'error-title': 'text-lg font-semibold text-red-700 mb-2',
  'error-message': 'text-red-600 mb-4',
  'retry-button': 'bg-red-600 text-white px-4 py-2 rounded text-sm font-medium hover:bg-red-700 transition-colors',
